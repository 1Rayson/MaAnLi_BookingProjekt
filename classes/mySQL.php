...
class MySQL {
    ...
    private $server = "mysql94.unoeuro.com"; // Change to domain name, e.g. www.iloveunicorns.com
    private $username = "port_als_dk"; // Change to the admins username of the server
    private $password = "3RxaE69bgerc"; // Change to the admins password of the server
    private $database = "port_als_dk_db"; // Change to the name of the database you would like to connect to on the server
